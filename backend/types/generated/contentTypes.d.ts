...
export interface ApiSearchItemSearchItem extends Schema.CollectionType {
  collectionName: 'search_items';
  info: {
    description: '';
    displayName: 'Search Item';
    pluralName: 'search-items';
    singularName: 'search-item';
  };
  options: {
...
export interface ApiSearchLogSearchLog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    last_visited: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::search-item.search-item': ApiSearchItemSearchItem;
